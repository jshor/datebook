...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4),y={id:"addalarm-alarm-alarm",tabindex:"-1"},A=n("a",{class:"header-anchor",href:"#addalarm-alarm-alarm","aria-hidden":"true"},"#",-1),f=n("code",null,"addAlarm(alarm: Alarm)",-1),N=n("p",null,[s("Adds an alarm. Multiple different alarms may be added to a single instance. Returns the "),n("code",null,"ICalendar"),s(" instance.")],-1),_=n("strong",null,[n("code",null,"alarm: Alarm")],-1),I=e(`<h3 id="example-2" tabindex="-1"><a class="header-anchor" href="#example-2" aria-hidden="true">#</a> Example</h3><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">const</span> alarm1<span class="token operator">:</span> Alarm <span class="token operator">=</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,1);function Y(U,G){const l=i("RouterLink"),t=i("Badge"),o=i("ExternalLinkIcon");return r(),d("div",null,[v,m,n("ul",null,[n("li",null,[k,s(" - Basic calendar "),a(l,{to:"/config/basic.html"},{default:c(()=>[s("configuration options")]),_:1}),s(".")])]),b,n("h2",h,[g,s(),T,s(),a(t,{text:"6.0.0",vertical:"middle"})]),E,n("h2",y,[A,s(),f,s(),a(t,{text:"6.0.0",vertical:"middle"})]),N,n("ul",null,[n("li",null,[_,s(" - "),a(l,{to:"/config/alarms.html"},{default:c(()=>[s("Alarm options")]),_:1}),s(".")])]),I,n("h2",R,[x,s(),D,s(),a(t,{text:"6.0.0",vertical:"middle"})]),C,n("h2",w,[S,s(),L,s(),a(t,{text:"6.0.0",vertical:"middle"})]),V,n("p",null,[s("Returns a generated "),n("a",M,[s("iCalendar"),a(o)]),s(" file content string containing the event details.")]),O,n("p",null,[s("Once an ICS file string is rendered, you can use "),n("a",P,[s("FileSaver.js"),a(o)]),s(" or a similar library to locally download the ICS file onto the user's device.")]),B])}const q=p(u,[["render",Y],["__file","icalendar.html.vue"]]);export{q as default};
